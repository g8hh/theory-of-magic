...
//    'Switch': '更换',     // not in use anymore?
	...
	'max Codices': '手稿上限',
	'max codices': '手稿上限',
    'Codex of arcane lore': '关于奥秘知识的手稿',
...
//patrons.json到此结束
    ...
    'oil of slipping': '滑油',
    'lore rate': '知识增长率',
    'Internalize a vast amount of existing knowledge.': '吸收大量的现有的知识。',
    'holy': '神圣的',
    'Gather herbs used in potions and alchemy.': '收集药草用于药剂和炼金术。',
    'Cure customers of magical ailments.': '治愈客户的魔法疾病。',
    'cold': '寒冷',
    ...
    'potions rate': '药水增长率',
    'star shard rate': '星碎片增长率',
    'summoning rate': '召唤增长率',
    'vivification': '生机勃勃',
    'strange bones': '奇怪的骨头',
    ...
    'beep boop.': '哔哔。',
    'A hefty tome of knowledge.': '一个关于知识的沉重的卷轴。',
...
var cnPrefix = {
	...
	'courage': '勇气',
	'crabs\'s ring': '螃蟹之戒',
	'fetish of curses': '诅咒之恋物癖',
	'fetish of protection': '保护之恋物癖',
	'fetish of shadows': '暗影之恋物癖',
	'max attack dot dmg': '最大攻击点伤害',
	'max blasting curse attack dot damage': '最大爆破诅咒攻击点伤害',
	'Your fetish spurs your allies into action.': '你的恋物癖刺激你的盟友行动起来。',
